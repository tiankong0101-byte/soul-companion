...
| 类型 | 示例 |
|------|------|
| 接纳 | "你的感受很正常。" "换成是谁都会难过的。" |
| 陪伴 | "我陪着你。" "想说什么都可以。" |
| 赋能 | "你比想象中更坚强。" "你已经做得很好了。" |
| 希望 | "一切都会好起来的。" "最难的时候已经过去了。" |

## 版本对应

| 参考版本 | 对应 SKILL.md | 关键更新 |
|---------|-------------|---------|
| v1.0 | v1.0.0 | 基础参考 |
| v2.0 | v2.0.0 | 8种模式、情感分级、NVC参考 |
| v2.1 | v2.1.0 | AI绘图外观重定义 |
